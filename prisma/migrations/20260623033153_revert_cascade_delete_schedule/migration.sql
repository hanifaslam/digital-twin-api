...
-- AddForeignKey
ALTER TABLE "Schedule" ADD CONSTRAINT "Schedule_study_program_id_fkey" FOREIGN KEY ("study_program_id") REFERENCES "StudyProgram"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
